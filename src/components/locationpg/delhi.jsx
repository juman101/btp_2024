...
import first from "../../components/locationpg/assets/Accident_type_dlh.png";
import second from "../../components/locationpg/assets/Collision_type_dlh.png";
import third from "../../components/locationpg/assets/delhi.jpeg";
export default function Delhi() {
  ...
  return (
    <div>
       <h1 className="text-2xl font-bold mb-4">Delhi Accident Data</h1>
